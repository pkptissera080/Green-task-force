...
<center>
  ...
  <table id="account_table">
    <tr>
      <th>Firstname</th>
      <td><input class="input" type="text" name="f_name" value="<?php echo $captainfirstname; ?>"></td>
    </tr>
    <tr>
      <td></td>
      <td></td>
    ...
    <tr>
      <th>Lastname</th>
      <td><input  class="input" type="text" name="l_name" value="<?php echo $captainlastname; ?>"></td>
    </tr>
    <tr>
      <td></td>
      <td></td>
    ...
    <tr>
      <th>Email</th>
      <td><input class="input" type="text" name="e_mail" value="<?php echo $captainemail; ?>"></td>
    </tr>
  </table>
...
if (isset($_POST['save']))
{
  ...
  else
  {
    ...
    $sql = "UPDATE login SET  firstname='$fname',lastname ='$lname',email ='$e__mail' WHERE username='$get_captain_name'";
